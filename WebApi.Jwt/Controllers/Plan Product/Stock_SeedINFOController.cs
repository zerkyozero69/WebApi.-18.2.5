    ...
    public class Stock_SeedINFOController : ApiController
    {
        ...
        public HttpResponseMessage Stockseedanimal()
        {
            try
            {
                ...
                if (HttpContext.Current.Request.Form["dldName"].ToString() != null)
                {
                    if (HttpContext.Current.Request.Form["dldName"].ToString() != "")
                    {
                        dldName = HttpContext.Current.Request.Form["dldName"].ToString();
                    }
                }


                DataSet ds = SqlHelper.ExecuteDataset(scc, CommandType.StoredProcedure, "sp_Stock_count", new SqlParameter("@OrganizationOid", OrganizeOid),new SqlParameter ("@dldName", dldName));
        ...
        public HttpResponseMessage StockAnimal()
        {
            try
            {
                ...
                ,new SqlParameter("@dldName", dldName));
